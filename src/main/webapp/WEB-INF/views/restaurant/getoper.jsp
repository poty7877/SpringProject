...
<!-- 불러오기용으로 패널정보만 표시 -->
<!-- .row close -->
<form id="reginfoForm" method="post" action="/restaurant/modoper"
					...
					<div class="col-md-6 ">
						<div class="input-group">
							<span class="input-group-addon">START</span> <input type="time"
								class="form-control" id="breakTime_start"
								value="${oper.breakTime_start}" /> <input type="hidden"
								name="breakTime_start" value="--:--">
						</div>
						<!--.input-group  -->
					</div>
					<!-- col-md-8 -->
					...
					<div class="col-md-6">
						<div class="input-group">
							<span class="input-group-addon">END</span> <input type="time"
								...
								value="${oper.breakTime_end}" /> <input type="hidden"
								name="breakTime_end" value="--:--">
						</div>
						<!--.input-group  -->
					</div>
					<!-- col-md-8 -->
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<div class="input-group" id="dayoff">
							...
							<!-- <input type="hidden" name=dayoff_weekCnt value="-"> <input
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<label for="adPayCheck">예약금 설정 <a href="#myModal"
							class="btn btn-danger btn-circle" id="queBtn2"
							data-toggle="modal"> <i class="fa fa-question-circle"></i>
						</a>
						</label>
						<div id="adPayCheck">
							<label class="radio-inline"> <input type="radio"
					...
					<div class="col-md-12 form-group">
						...
						<div>
							<input type="hidden" id="menuReserv" name="menuReserv"
								value="${oper.menuReserv}"> <input type="checkbox"
								id="inputMenuRev" name="menuReserv" value="true"> 메뉴예약
							필요<br>
