					...
					<div class="panel panel-info">
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-8">
									<blockquote>
										<small>예약금을 설정하시면 단체예약시 예약금을 선결제한 회원의 예약정보만 받을 수 있습니다.</small>
										<small>예약금을 선결제할 최소 예약인원과 선결제 받을 금액을 설정할 수 있습니다.</small> <small>설정을
											원하시면 [설정함]을, 원하지 않으면 [설정안함]을 선택하세요.</small>
									</blockquote>
									<label class="checkbox-inline"> <input type="checkbox"
