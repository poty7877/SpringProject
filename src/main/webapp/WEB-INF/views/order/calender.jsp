...
%>
	<div>
		<h1>
			식사 <span> 예약 </span> 오신것을 <span> 환영합니다. </span>
		</h1>
	</div>
	...
	<div align="center" width="70%">
			...
			<div style="display:inline-block"  fontsize = "2">
			<table>
			<tr>
				<td> 예약일 </td>
				<td>
				<input id="selectedDate" name="selectedDate" value="<%=year%>.<%=month%>.<%=day%>" readonly="readonly">			
				</td>
			</tr>
			<tr>
				<td> 예약가능시간 </td>
